...
if os.path.exists("./app/data/model_RandomForest.joblib") :
    print("Load model...")
    model = load("./app/data/model_RandomForest.joblib")
else :
    print("Train model...")
    ...
    dump(model, "./app/data/model_RandomForest.joblib")
...
if os.path.exists("./app/data/model_LogisticRegression.joblib") :
    print("Load model...")
    model = load("./app/data/model_LogisticRegression.joblib")
else : 
    print("Train model...")
    cv = StratifiedKFold(4)
    ...
    print(grid.best_params_)
    model = grid.best_estimator_
    dump(model, "./app/data/model_LogisticRegression.joblib")
...
if os.path.exists("./app/data/model_RidgeClassifier.joblib") :
    print("Load model...")
    model = load("./app/data/model_RidgeClassifier.joblib")
else : 
        print("Train model...")
        cv = StratifiedKFold(4)
        ...
        print(grid.best_params_)
        model = grid.best_estimator_
        dump(model, "./app/data/model_RidgeClassifier.joblib")
...
if os.path.exists("./app/data/model_MLPC.joblib") :
    print("Load model...")
    model = load("./app/data/model_MLPC.joblib")
else : 
        print("Train model...")
        cv = StratifiedKFold(4)
        ...
        print(grid.best_params_)
        model = grid.best_estimator_
        dump(model, "./app/data/model_MLPC.joblib")
